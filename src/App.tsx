...
const httpLink = createHttpLink({
  ...
  headers: {
    'x-hasura-admin-secret': 'YOUR_HASURA_ADMIN_SECRET' // TODO
  }
})
...
export const App = () => {
  ...
  const [delete_todos] = useMutation(DELETE_TODO)
  ...
  return (
    <div className='App'>
      ...
      {/** Todo list */}
      <ul>
        {typeof data !== 'undefined' && data.todos.map(todo => (
          <li key={todo.id}>
